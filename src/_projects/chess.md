...
I refactored some parts of this project numerous times. I also used it for experimenting with topics I was reading about in my free time. For example, I refactored the piece movements to utilize the [null object pattern](https://en.wikipedia.org/wiki/Null_object_pattern) after reading about it. Another example was using a [pipeline](<https://en.wikipedia.org/wiki/Pipeline_(software)>) to process special moves such as castling.
